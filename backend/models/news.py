...
class Category(Base):
    ...
    sort_order: Mapped[int] = mapped_column(default=0,unique=True,comment="排序顺序")

#便于调试，打印对象
def __repr__(self) -> str:
    return f"<{self.__class__.__name__}(id={self.id}, name={self.name}, sort_order={self.sort_order})>"
